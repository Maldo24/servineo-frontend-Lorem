...
import {
    ...
    DropdownMenuItem,
    DropdownMenuTrigger,
} from '@/componentsLumonis/ui/dropdown-menu';
            ...
            >
                {sortOptions.map((option) => (
                    <DropdownMenuItem
                        ...
                        className={`cursor-pointer !px-3 !py-2 !rounded-md !transition-colors ${value === option.value // Comparación correcta con valor backend
